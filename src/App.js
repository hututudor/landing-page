			...
			<div>
				<header className="header">
					<div className="header__main">
						...
						<ReactTypingEffect
							...
							staticText=">"
							text={['Developer.', 'Designer.', 'Programmer.']}
							eraseDelay={3000}
							speed={100}
						/>
					</div>
					...
					<div className="col-md-4 col-md-offset-4 col-sm-12 about">
						...
						<div className="about__text-box">
							<p className="about__text">
								I have done a series of projects, varying from web apps to games
								and even designed some websites. This is what I do and I like
								it. My speciality is web development. I love it!
							</p>
						</div>
					</div>
				</section>
				...
				<footer className="footer">
					<p className="footer__text">
						...
						<a href="http://tudorhutu.ro" className="footer__link">
							{' '}
							Hutu Tudor
						</a>
						.
